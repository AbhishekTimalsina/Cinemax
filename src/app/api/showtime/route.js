...
export async function GET() {
  ...
  let data = await ShowTimes.find({})
    .populate({
      path: "availableShows", // Specify the array field
      populate: {
        path: "seatsId", // Specify the field within the array's objects to populate
        model: "Seat", // Specify the model to use for population (optional but recommended)
      },
    })
