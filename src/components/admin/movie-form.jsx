...
export default function MovieForm({ movie, onSubmit, isSubmitting }) {
  ...
  useEffect(() => {
    if (movie) {
      ...
      setImagePreview(movie.image || "/placeholder.svg?height=400&width=300");
    }
  }, [movie]);
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  value={formData.releaseDate}
                  onChange={handleInputChange}
                  placeholder="e.g. Now Showing or Coming May 15"
                  className={`mt-1 block w-full border ${
                    errors.releaseDate
                      ? "border-red-500"
                      : "border-gray-300 dark:border-gray-600"
          ...
          <div>
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative h-[300px] w-[200px] overflow-hidden rounded-lg border border-gray-300 dark:border-gray-600">
                <img
              ...
              <label className="cursor-pointer flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      <div className="px-6 py-4 flex justify-end space-x-4">
        <button
          ...
          className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 dark:focus:ring-offset-gray-800"
        >
          Cancel
        </button>
        <button
